...
def add_sections(session: Session):
    ...
    while not unique_location or not unique_professor:
        ...
        while semester != "Fall" and semester != "Spring" and semester != "Winter" and \
                semester != "Summer I" and semester != "Summer II":
...
def delete_department(session: Session):
    ...
    if n_courses > 0:
        ...
        confirmation = input(f"Are you sure you want to delete department: {department.name}? (y/n): ")
...
def delete_course(session: Session):
    ...
    confirmation = input(f"Are you sure you want to delete course: {course.name}? (y/n): ")
    if confirmation.lower() == 'y':
...
def delete_sections(session: Session):
    ...
    confirmation = input(f"Are you sure you want to delete section: {old_section.section_number}? (y/n): ")
    if confirmation.lower() == 'y':
